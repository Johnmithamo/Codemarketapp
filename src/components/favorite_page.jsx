...
export default function Favorites() {
  ...
  const loadFavorites = async () => {
    try {
      const res = await fetch(
        "https://movie-nova-5.onrender.com/favorites/full",
        {
          headers: {
  ...
  const removeFromFavorites = async (id) => {
    try {
      ...
      // backend returns the updated list of favorite IDs (strings),
      // so just drop the removed item locally instead of refetching
