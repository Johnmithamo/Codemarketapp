...
export default function BuyerProfilePage() {
  ...
  useTourRegister("profileBuyer", setPage);
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="mt-[150px] px-4 space-y-3 py-16">
        <MenuItem data-tour-id="profile1-saved" title="Saved Items" icon={<Bookmark size={18} />} onClick={() => go("saved")} />
        <MenuItem data-tour-id="profile1-activity" title="Activity" icon={<Activity size={18} />} onClick={() => go("activity")} />
        <MenuItem data-tour-id="profile1-settings" title="Settings" icon={<Settings size={18} />} onClick={() => go("settings")} />
      </div>
    </div>
  );
}
